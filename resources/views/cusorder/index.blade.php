...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Cusorder</div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Nameproduct</th><th>Amount</th><th>Price</th><th>Status</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($cusorder as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->nameproduct }}</td><td>{{ $item->amount }}</td><td>{{ $item->price }}</td><td>{{ $item->status }}</td>
                                        <!-- <td>
